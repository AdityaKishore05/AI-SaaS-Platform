...
export default function VideoCaptionPage() {
  ...
  const handleGenerate = () => {
    ...
    const prompt = `Generate video captions/subtitles for the following transcript in ${language}. Format with timecodes if possible or just clear line breaks. Transcript: "${transcript}"`;
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-foreground">Video Caption Generator</h1>
        <p className="text-muted-foreground">Auto-generate captions or subtitles from your transcript.</p>
      </div>
          ...
          <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={generateText.isPending || !transcript}
