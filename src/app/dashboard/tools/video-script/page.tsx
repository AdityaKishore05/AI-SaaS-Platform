...
export default function VideoScriptPage() {
  ...
  const handleGenerate = () => {
    ...
    const prompt = `Write a ${tone.toLowerCase()} video script about "${topic}". Include intro, scene-by-scene dialogue, and call to action.`;
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-foreground">AI Video Scriptwriter</h1>
        <p className="text-muted-foreground">Generate full video scripts for YouTube, Reels, or Shorts.</p>
      </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Top 10 Travel Destinations for 2025"
                  value={topic}
